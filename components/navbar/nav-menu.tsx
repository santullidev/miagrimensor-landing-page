...
export const NavMenu = (props: NavigationMenuProps) => {
  ...
  return (
    <NavigationMenu {...props}>
        ...
        <NavigationMenuItem>
          <NavigationMenuLink asChild>
                         <Link href="/contacto" className="block py-1.5 px-2 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-slate-900 dark:text-slate-100 font-medium text-sm">
              Contacto
            </Link>
          </NavigationMenuLink>
        </NavigationMenuItem>
