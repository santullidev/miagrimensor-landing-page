...
export default function ContactoContent({ settings }: ContactoContentProps) {
              ...
              <CardContent className="space-y-4">
                ...
                >
                  <a href={settings.whatsappUrl} target="_blank" rel="noopener noreferrer">
                    {settings.whatsappButtonText} <ArrowUpRight className="ml-2 h-5 w-5" strokeWidth={2} />
                  </a>
                </Button>
                ...
                <div className="grid gap-4 pt-4">
                  <div className="flex items-center gap-4 p-4 rounded-modern bg-card border border-green/20 hover:border-green/40 transition-all duration-250 hover:shadow-soft">
                    ...
                    <div>
                      ...
                      <Link href={settings.phoneHref || "#"} className="text-sm text-muted-foreground hover:text-green transition-colors">
                        {settings.phone}
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-modern bg-card border border-green/20 hover:border-green/40 transition-all duration-250 hover:shadow-soft">
                    ...
                    <div>
                      ...
                      <Link href={`mailto:${settings.email}`} className="text-sm text-muted-foreground hover:text-green transition-colors">
                        {settings.email}
                      </Link>
                    </div>
                  </div>
