        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div className="grid gap-8 sm:gap-12">
            {services.map((service, index) => (
              <Card key={service.id} className="overflow-hidden border-2 hover:border-green/50 transition-all duration-300 hover:shadow-soft-lg cursor-pointer" onClick={() => window.location.href = `/servicios/${service.slug}`}>
